...
import {calculateAge} from 'api/user/utils/userDate.util';
...
describe('test stack ', () => {
  test('cast a Date object to string dd-mm-yyyy format', () => {
    ...
    const dateFormatted: string =
      DateFormatterUtil.date_to_ddmmyyyy_string(dateToTest);
  ...
  test('cast a string yyyy-mm-dd date format to a date object', () => {
    ...
    const dateFormatted: Date =
      DateFormatterUtil.yyyymmdd_string_to_date(dateToTest);
